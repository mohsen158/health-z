                  ...
                  <Col span={8}>
                    <Button
                      onClick={() => {
                        ...
                        dummy.value = JSON.stringify(JSON.parse(proofData).proof.a);
                        dummy.select();
                  ...
                  <Col span={8}>
                    <Button
                      onClick={() => {
                        ...
                        dummy.value = JSON.stringify(JSON.parse(proofData).proof.b);
                        dummy.select();
                        document.execCommand("copy");
                        dummy.style.display = "none";
                      }}
                  ...
                  <Col span={8}>
                    <Button
                      onClick={() => {
                        ...
                        dummy.value = JSON.stringify(JSON.parse(proofData).proof.c);
                        dummy.select();
                        document.execCommand("copy");
                        dummy.style.display = "none";
                      }}
  ...
  function info(message, value) {
    Modal.info({
      ...
      onOk() {
        if (message == "Hash is : ") {
          setHash(value);
          console.log("prrofdata-->", value);
        } else if (message == "Proof is : ") {
          setProofData(value);
          console.log(value);
        }
        var dummy = document.createElement("textarea");
